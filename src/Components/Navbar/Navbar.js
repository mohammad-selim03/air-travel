    ...
    return (
        <div className="navbar mt-[-20]">
            ...
            <div className="navbar-end">
                <Link to='/services'><button className="btn bg-gradient-to-r from-cyan-400 to-blue-700 font-bold text-white rounded-xl py-2 px-7 ">Flight Booking</button></Link>
            </div>
            ...
            {user?.email && <Link to='/dashboard'><label htmlFor="dashboard-drawer" className="btn bg-gradient-to-r from-lime-400 to-emerald-700 text-white font-bold rounded-xl mx-2 drawer-button lg:hidden">Dashboard</label></Link>}
            <div>
            </div>
        </div>
    );
